										...
										<div class="col-sm-12">
												<div class="white-box">
													...
													<tr>
														...
														<a href="<?php echo base_url() ?>back/responsi/edit/<?php echo $list['id_responsi'] ?>"> <label class="btn btn-info" >EDIT</a> &nbsp 
                            <?php
                        //$level=$this->session->userdata('level');
                        // if($level == 1){?>
                            <a href="<?php echo base_url() ?>back/responsi/delete/<?php echo $list['id_responsi'] ?>"onclick="return confirm ('Apakah Anda yakin akan menghapus data ini ?')"><label class="btn btn-danger" >DELETE</a><?php } ?></td></label></a></label></a></td></tr>
                          </tr>
