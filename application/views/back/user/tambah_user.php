			...
			<div class="container-fluid">
				<div class="row bg-title">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						<h4 class="page-title">Tambah Data User</h4> </div>
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> <a href="<?php echo base_url() ?>back/user/tambah" class="btn btn-danger pull-right m-l-20 btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light">Refresh</a>
						<ol class="breadcrumb">
							<li><a href="<?php echo base_url() ?>front/Log/logout">Hospital</a></li>
							<li><a href="#">User</a></li>
							<li class="active"><a href="<?php echo base_url() ?>back/user/tambah">Tambah Data User</a></li>
						</ol>
					</div>
					<!-- /.col-lg-12 
...
<!-- /.row -->
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="white-box">
							<h3 class="box-title m-b-0" align="center">Form Data User</h3>
							<div class="row">
		  ...
		  <div class="about-top-info">
			  ...
			  <div class="col-md-8 about-desc">
				<div class="col-md-6" align="center">
								...
								<div class="col-sm-12 col-xs-12">
									<form class="form-horizontal" method="post" action="<?php echo base_url() ?>back/user/tambah_aksi">
